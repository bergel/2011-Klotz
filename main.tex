...
Klotz is a \chg{F}{f}ramework, based on \del{quite} simple 3D graphic elements,
...
\ins{The goal of Klotz is to offer a flexible solution to visualize software in 3 dimensions. Klotz offer a scripting language, an API and an easel to ``compose'' a visualization.}
